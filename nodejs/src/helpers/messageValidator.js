export class MessageValidator {
    ...
    static isRequired(field) {
        return this.messageFormat(field, 'required');
    }
    /**
     * isInt
     *
     ...
     */
    static isInt(field) {
        return this.messageFormat(field, 'it has to be a whole number');
    }
    /**
     * isString
     *
    ...
    static isString(field) {
        return this.messageFormat(field, 'has to be a character string');
    }
    /**
     * isDecimal
     *
    ...
    static isDecimal(field) {
        return this.messageFormat(field, 'it has to be of decimal type');
    }
    /**
     * isLength
     *
